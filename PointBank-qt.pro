...
contains(pointbank_NEED_QT_PLUGINS, 1) {
    DEFINES += pointbank_NEED_QT_PLUGINS
...
# also add new translations to src/qt/pointbank.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/pointbank_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/pointbank-qt.rc
...
windows:RC_FILE = src/qt/res/pointbank-qt.rc
...
macx:ICON = src/qt/res/icons/pointbank.icns
macx:TARGET = "pointbank-Qt"
