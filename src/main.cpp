...
//Agregado para prueba preliminar
...
const string strMessageMagic = "PointBank Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PointBank", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "11/12/2018 - Es necesaria una política monetaria autónoma en los cripto activos";
        CTransaction txNew;
        txNew.nTime = 1544509932;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1544509932;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 60704 : 60704;
        ...
        assert(block.hashMerkleRoot == uint256("0x81b39946b0d300df694cfd6b178aba72481832c00884c9ec6cd40806ef32df81"));
